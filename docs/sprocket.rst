...
#. The first line imports the build123d CAD system
...
#. The fourth line uses the build123d exporter functionality to save the generated
...
.. autoclass:: Sprocket
	:members: sprocket_pitch_radius, sprocket_circumference, plan

Most of the Sprocket parameters are shown in the following diagram:

.. image:: assets/sprocket_dimensions.png
...
.. note::
	...
	Units in build123d are defined so that 1 represents one millimeter but ``MM = 1`` makes this
	explicit.
